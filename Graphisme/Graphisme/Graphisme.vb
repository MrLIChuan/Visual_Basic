Public Class frmGraphisme
    'On peut initialiser les variables à la déclaration ! 
    Dim sngEchelleX As Single = 6
    Dim sngEchelleY As Single = -10     'Pourquoi le “ – “ ? 
    Dim sngOrigineX As Single = 8
    Dim sngOrigineY As Single = -6
    'creation d’un objet graphisme  
    Dim gphDessin As System.Drawing.Graphics

    Private Sub cmdTracerAxes_Click(sender As Object, e As EventArgs) Handles cmdTracerAxes.Click
        Dim ftMessage As New Font("Arial", 1, FontStyle.Bold)

        gphDessin = pctGraphe.CreateGraphics()
    ...
    Private Sub cmdTracerDroiteCercle_Click(sender As Object, e As EventArgs) Handles cmdTracerDroiteCercle.Click
        Dim P As Single
        P = 0.01
        gphDessin.ScaleTransform(1, -1) 'Changement d’échelle, inversion de l'axe y
    ...
    Private Sub cmdTracerCourbe_Click(sender As Object, e As EventArgs) Handles cmdTracerCourbe.Click
    ...
    Private Sub cmdZoom_Click(sender As Object, e As EventArgs) Handles cmdZoom.Click
        ...
        sngEchelleX = 1.2 * sngEchelleX     'change l’echelle des X 
        sngEchelleY = 1.2 * sngEchelleY     'change l’echelle des Y 
